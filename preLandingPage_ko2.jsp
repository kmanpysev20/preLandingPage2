	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				...
				<div class="box-row">
					<button class="btn platform">가격</button>
					<button class="btn platform">품질</button>
					<button class="btn platform">디자인</button>
					<button class="btn platform">브랜드 선호도</button>
					<button class="btn platform">편의성</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 제품을 구매할 때 얼마나 가격 비교를 하시나요?</h2>
				<div class="box-row">
					<button class="btn situation">온라인 플랫폼만 대상으로 비교</button>
					<button class="btn situation">철저한 비교 후 최저가 구매</button>
					<button class="btn situation">안함</button>
				</div>
			</article>
		</main>
