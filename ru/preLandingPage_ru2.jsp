...
<title>preLandingPage_ru2</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. What is the most considered factor when buying a product?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">Price</button>
					<button class="btn platform" value="2">Quality</button>
					<button class="btn platform" value="3">Design</button>
					<button class="btn platform" value="4">Brand preference</button>
					<button class="btn platform" value="5">Convenience</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. How far do you compare price when buying a product?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">Comparison only for online platforms</button>
					<button class="btn situation" value="2">Buy at the lowest price after comparing</button>
					<button class="btn situation" value="3">No</button>
				</div>
			</article>
		</main>
