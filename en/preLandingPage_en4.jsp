...
<title>preLandingPage_en4</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. How did you find on your purchased product?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">TV/Radio Ad</button>
					<button class="btn platform" value="2">Recommend by an acquaintance</button>
					<button class="btn platform" value="3">online Ad</button>
					<button class="btn platform" value="4">SNS</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. What is the biggest factor influencing on your purchase decision?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">Online Ad</button>
					<button class="btn situation" value="2">Recommend by an acquaintance</button>
					<button class="btn situation" value="3">SNS content</button>
					<button class="btn situation" value="4">Media AD</button>
					<button class="btn situation" value="5">review</button>
				</div>
			</article>
		</main>
