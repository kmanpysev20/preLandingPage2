...
<title>preLandingPage_en3</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. How did you check authenticity of product before buying?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">Trusted Buyer</button>
					<button class="btn platform" value="2">Acquired various certifications</button>
					<button class="btn platform" value="3">Check reviews</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. What was the reason for scanning on purchased product?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">Suspect it's fake</button>
					<button class="btn situation" value="2">To get A/S</button>
					<button class="btn situation" value="3">Participate in events</button>
					<button class="btn situation" value="4">ETC</button>
				</div>
			</article>
		</main>
