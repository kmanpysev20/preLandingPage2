...
<title>preLandingPage_en1</title>
...
main .contents-gender .gender.img-men {
	background: url('./images/img-men-en.svg') no-repeat center/contain;
}

main .contents-gender .gender.img-women {
	background: url('./images/img-women-en.svg') no-repeat center/contain;
}
...
.cop .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-cop-en.svg') no-repeat center/cover !important;
}
...
.cop .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-cop-en.svg') no-repeat center/cover !important;
}

.cop .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-cop-en.png') no-repeat center/cover;
	width: 10.5rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.cop .img-talk1 {
	background: url('./images/img-info-cop-en.png') no-repeat center/cover !important;
	width: 13.7rem !important;
	left : 5.1rem !important;
}
.cop .img-talk2 {
	background: url('./images/img-data-cop-en.png') no-repeat center/cover !important;
	width: 12.9rem !important;
	left : 5.4rem !important;
}
.cop .img-talk3 {
	background: url('./images/img-genue-cop-en.png') no-repeat center/cover !important;
...
.cop .img-talk4 {
	background: url('./images/img-almost-cop-en.png') no-repeat center/cover !important;
	width: 15.5rem !important;
	height: 4.8rem !important;
	left : -14rem !important;
}
.cop .img-talk5 {
	background: url('./images/img-complete-cop-en.png') no-repeat center/cover !important;
...
.ht .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-ht-en.svg') no-repeat center/cover !important;
}
...
.ht .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-ht-en.svg') no-repeat center/cover !important;
}

.ht .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-ht-en.png') no-repeat center/cover;
	width: 10.5rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.ht .img-talk1 {
	background: url('./images/img-info-ht-en.png') no-repeat center/cover !important;
	width: 13.7rem !important;
	left : 5.1rem !important;
}
.ht .img-talk2 {
	background: url('./images/img-data-ht-en.png') no-repeat center/cover !important;
	width: 12.9rem !important;
	left : 5.4rem !important;
}
.ht .img-talk3 {
	background: url('./images/img-genue-ht-en.png') no-repeat center/cover !important;
	width: 16.9rem !important;
	height: 3.6rem !important;
	left : -5.5rem !important;
	top : -2.4rem !important;
...
.ht .img-talk4 {
	background: url('./images/img-almost-ht-en.png') no-repeat center/cover !important;
	width: 15.5rem !important;
	height: 4.8rem !important;
	left : -14rem !important;
}
.ht .img-talk5 {
	background: url('./images/img-complete-ht-en.png') no-repeat center/cover !important;
	width: 17.8rem !important;
	height: 4.7rem !important;
	left : -16.2rem !important;
}
...
.gl .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-gl-en.svg') no-repeat center/cover !important;
}
...
.gl .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-gl-en.svg') no-repeat center/cover !important;
}

.gl .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-gl-en.png') no-repeat center/cover;
	width: 10.5rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.gl .img-talk1 {
	background: url('./images/img-info-gl-en.png') no-repeat center/cover !important;
	width: 13.7rem !important;
	left : 5.1rem !important;
}
.gl .img-talk2 {
	background: url('./images/img-data-gl-en.png') no-repeat center/cover !important;
	width: 12.9rem !important;
	left : 5.4rem !important;
}
.gl .img-talk3 {
	background: url('./images/img-genue-gl-en.png') no-repeat center/cover !important;
	width: 16.9rem !important;
	height: 3.6rem !important;
	left : -5.5rem !important;
	top : -2.4rem !important;
...
.gl .img-talk4 {
	background: url('./images/img-almost-gl-en.png') no-repeat center/cover !important;
	width: 15.5rem !important;
	height: 4.8rem !important;
	left : -14rem !important;
}
.gl .img-talk5 {
	background: url('./images/img-complete-gl-en.png') no-repeat center/cover !important;
	width: 17.8rem !important;
	height: 4.7rem !important;
	left : -16.2rem !important;
}
...
<body>
	<div class="wrap <%= appClass %>">
		...
		<main>
			<h1><strong>WAIT!</strong><br class="br"><p class="tit">We are verifying on its authenticity</p><br><p>Select your gender</p></h1>
			...
			<article class="contents contents-age">
				<h2>1. Select your age group</h2>
				<div class="box-row">
					<button class="btn age" value="1">Teens</button>
					<button class="btn age" value="2">20`s</button>
					<button class="btn age" value="3">30`s</button>
					<button class="btn age" value="4">40`s</button>
					<button class="btn age" value="5">Above 50`s</button>
				</div>
			</article>
			<article class="contents contents-show">
				<h2>2. Which platform do you use for shopping?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">Mobile app</button>
					<button class="btn platform" value="2">Website</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. Which platform do you prefer for shopping?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">Online</button>
					<button class="btn situation" value="2">Offline</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>4. Which platform do you prefer to purchase?</h2>
				<div class="box-row">
					<button class="btn preference" value="1">Official brand mall</button>
					<button class="btn preference" value="2">Online shopping mall</button>
				</div>
			</article>
		</main>
		...
		<div class="modal modal-select">
			<div class="modal-popup">
				<div class="box">
					<p class="txt">Hold on! There are missing parts.<i class="ic-handUp"></i></p>
					<p class="txt">(Once you complete on the following parts, click on the check button)</p>
		...
		<!-- 선택 안되었을 때 팝업 [e] -->
		<button class="complete-btn">Check out now on your authentication result!</button>
	</div>
...
function updateUI() {
  ...
  const isCompleted = activeCount === 5;
  ...
  $warp.removeClass(function(i, cls) {
	...
	if (hasProgress) {
		...
		const countEl = '<div class="count-wrap"><span class="progress-count">'+0+ + progressText + '</span> /<span class="end-count">5</span></div>';
		$('.br').addClass('none');
	...
	// 4-3. 버튼 상태 갱신
	$completeBtn.toggleClass('change', isCompleted) .text( isCompleted ? 'Check out now on your authentication result!' : 'Please take part in the official authenticity verification survey!');
	...
	// 4-5. 타이틀 텍스트 수정
	if (activeCount === 1) {
		$('.tit').text('Preparing on your scanned information')
	} else if (activeCount === 2 ) {
		$('.tit').text('Analyzing on authenticity')
	} else if (activeCount === 3 ) {
		$('.tit').text('Reviewing on product authenticity')
	} else if (activeCount === 4 ) {
		$('.tit').text('Checking on its brand verification information')
	} else if (activeCount === 5 ) {
		$('.tit').text('Completed! Click on the button at below.')
	} else {
		$('.tit').text('Verifying authenticity')
	}
  ...
  if (activeCount === 0) {
    ...
    $box.css('left', 'calc(25% - 6.8rem)');
  } else {
    $box.css('left', 'calc(' + (activeCount * 20) + '% - 6.8rem)');
  }
...
// 7) 정품결과 확인 버튼
	function completeBtn() {
		 $('.complete-btn').on('click', function() {
	        // 각 선택된 값을 가져오기
	        if($('.gender').hasClass('active') && $('.age').hasClass('active') && $('.platform').hasClass('active') && $('.situation').hasClass('active') && $('.preference').hasClass('active')) {
	            // form을 동적으로 생성
	            ...
	            form.append('<input type="hidden" name="answer3" value="' + $('.preference.active').val() + '">');
