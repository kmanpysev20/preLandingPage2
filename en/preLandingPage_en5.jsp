...
<title>preLandingPage_en5</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. How often do you buy similar products in a year?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">1 time</button>
					<button class="btn platform" value="2">2~4 times</button>
					<button class="btn platform" value="3">5 more times</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. Do you tend to buy the similar products more in advance?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">Yes</button>
					<button class="btn situation" value="2">No</button>
				</div>
			</article>
		</main>
