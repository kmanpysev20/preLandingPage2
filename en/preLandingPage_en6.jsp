...
<title>preLandingPage_en6</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. What is the platform of your purchased channel?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">Online open market</button>
					<button class="btn platform" value="2">Used trade</button>
					<button class="btn platform" value="3">Acquaintance authentication</button>
					<button class="btn platform" value="4">Offline road shop</button>
					<button class="btn platform" value="5">SNS individual seller</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. What is your biggest reason for selecting on the following seller?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">Low price</button>
					<button class="btn situation" value="2">Trusted source of purchase</button>
					<button class="btn situation" value="3">Reviews, Excellent ratings</button>
					<button class="btn situation" value="4">limited places to buy</button>
				</div>
			</article>
		</main>
...
function completeBtn() {
		...
		if($('.gender').hasClass('active') && $('.age').hasClass('active') && $('.platform').hasClass('active') && $('.situation').hasClass('active')) {
			...
			form.append('<input type="hidden" name="conditionCheck" value="가품">');
