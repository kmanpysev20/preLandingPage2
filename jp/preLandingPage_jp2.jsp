...
<title>preLandingPage_jp2</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 商品を購入する際に最初に考慮する項目は何ですか？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">価格</button>
					<button class="btn platform" value="2">品質</button>
					<button class="btn platform" value="3">デザイン</button>
					<button class="btn platform" value="4">ブランドのお好み</button>
					<button class="btn platform" value="5">便利性</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 商品を購入する際に価格比較しますか？</h2>
				<div class="box-row">
					<button class="btn situation" value="1">オンラインプラットフォームで比較</button>
					<button class="btn situation" value="2">最低価格に購入</button>
					<button class="btn situation" value="3">比較しない</button>
				</div>
			</article>
		</main>
