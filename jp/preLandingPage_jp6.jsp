...
<title>preLandingPage_jp6</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 購入ルートはどうなりますか？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">オンラインオープンマーケット</button>
					<button class="btn platform" value="2">中古取引先</button>
					<button class="btn platform" value="3">知人からプレゼ</button>
					<button class="btn platform" value="4">ントオフラインロードショップ</button>
					<button class="btn platform" value="5">SNS個人販売者</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 購入した販売先を選択した一番の理由は何ですか？</h2>
				<div class="box-row">
					<button class="btn situation" value="1">安い価格</button>
					<button class="btn situation" value="2">信頼できる購入先</button>
					<button class="btn situation" value="3">レビュー、評価</button>
					<button class="btn situation" value="4">地域限定販売先</button>
				</div>
			</article>
		</main>
...
function updateUI() {
  ...
  $warp.removeClass(function(i, cls) {
	...
	// 4-3. 버튼 상태 갱신
	$completeBtn.toggleClass('change', isCompleted) .text( isCompleted ? 'Check out now on your authentication result!' : 'Please take part in the official authenticity verification survey!');$completeBtn.toggleClass('change', isCompleted) .text( isCompleted ? '真贋判定の結果をご確認くださいませ。' : '真贋判定アンケートにご参加くださいませ。');
