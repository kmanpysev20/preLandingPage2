...
<title>preLandingPage_jp4</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 購入した商品をどんな経路で知りましたか？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">テレビ/ラジオ広告知</button>
					<button class="btn platform" value="2">知りありからのおすすめ</button>
					<button class="btn platform" value="3">オンライン</button>
					<button class="btn platform" value="4">広告SNS</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 購入決定に最も大きな影響を与える要因は何ですか？</h2>
				<div class="box-row">
					<button class="btn situation" value="1">オンライン広告</button>
					<button class="btn situation" value="2">知りありからのおすすめ</button>
					<button class="btn situation" value="3">SNSコンテンツ</button>
					<button class="btn situation" value="4">メディア広告</button>
					<button class="btn situation" value="5">レビュー</button>
				</div>
			</article>
		</main>
