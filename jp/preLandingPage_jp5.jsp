...
<title>preLandingPage_jp5</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 購入した製品と同じ種類の商品を年に何回購入しますか？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">1回</button>
					<button class="btn platform" value="2">2〜4回</button>
					<button class="btn platform" value="3">5回以上</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 購入決定に最も大きな影響を与える要因は何ですか？</h2>
				<div class="box-row">
					<button class="btn situation" value="1">はい</button>
					<button class="btn situation" value="2">いいえ</button>
				</div>
			</article>
		</main>
