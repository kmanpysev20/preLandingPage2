...
<title>preLandingPage_jp1</title>
...
main .contents-gender .gender.img-men {
	background: url('./images/img-men-jp.svg') no-repeat center/contain;
}

main .contents-gender .gender.img-women {
	background: url('./images/img-women-jp.svg') no-repeat center/contain;
}
...
.cop .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-cop-jp.svg') no-repeat center/cover !important;
}
...
.cop .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-cop-jp.svg') no-repeat center/cover !important;
}

.cop .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-cop-jp.png') no-repeat center/cover;
	width: 14.4rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.cop .img-talk1 {
	background: url('./images/img-info-cop-jp.png') no-repeat center/cover !important;
	width: 16.7rem !important;
	left : 5.1rem !important;
}
.cop .img-talk2 {
	background: url('./images/img-data-cop-jp.png') no-repeat center/cover !important;
	width: 14.8rem !important;
	left : 5.4rem !important;
}
.cop .img-talk3 {
	background: url('./images/img-genue-cop-jp.png') no-repeat center/cover !important;
...
.cop .img-talk4 {
	background: url('./images/img-almost-cop-jp.png') no-repeat center/cover !important;
	width: 15.2rem !important;
	height: 4.8rem !important;
	left : -14rem !important;
}
.cop .img-talk5 {
	background: url('./images/img-complete-cop-jp.png') no-repeat center/cover !important;
...
.ht .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-ht-jp.svg') no-repeat center/cover !important;
}
...
.ht .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-ht-jp.svg') no-repeat center/cover !important;
}

.ht .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-ht-jp.png') no-repeat center/cover;
	width: 14.4rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.ht .img-talk1 {
	background: url('./images/img-info-ht-jp.png') no-repeat center/cover !important;
	width: 16.7rem !important;
	left : 5.1rem !important;
}
.ht .img-talk2 {
	background: url('./images/img-data-ht-jp.png') no-repeat center/cover !important;
	width: 14.8rem !important;
	left : 5.4rem !important;
}
.ht .img-talk3 {
	background: url('./images/img-genue-ht-jp.png') no-repeat center/cover !important;
	width: 19.6rem !important;
	height: 3.6rem !important;
	left : -5.5rem !important;
	top : -2.4rem !important;
...
.ht .img-talk4 {
	background: url('./images/img-almost-ht-jp.png') no-repeat center/cover !important;
	width: 15.2rem !important;
	height: 4.8rem !important;
	left : -14rem !important;
}
.ht .img-talk5 {
	background: url('./images/img-complete-ht-jp.png') no-repeat center/cover !important;
	width: 17.8rem !important;
	height: 4.7rem !important;
	left : -16.2rem !important;
}
...
.gl .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-gl-jp.svg') no-repeat center/cover !important;
}
...
.gl .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-gl-jp.svg') no-repeat center/cover !important;
}

.gl .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-gl-jp.png') no-repeat center/cover;
	width: 14.4rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.gl .img-talk1 {
	background: url('./images/img-info-gl-jp.png') no-repeat center/cover !important;
	width: 16.7rem !important;
	left : 5.1rem !important;
}
.gl .img-talk2 {
	background: url('./images/img-data-gl-jp.png') no-repeat center/cover !important;
	width: 14.8rem !important;
	left : 5.4rem !important;
}
.gl .img-talk3 {
	background: url('./images/img-genue-gl-jp.png') no-repeat center/cover !important;
	width: 19.6rem !important;
	height: 3.6rem !important;
	left : -5.5rem !important;
	top : -2.4rem !important;
...
.gl .img-talk4 {
	background: url('./images/img-almost-gl-jp.png') no-repeat center/cover !important;
	width: 15.2rem !important;
	height: 4.8rem !important;
	left : -14rem !important;
}
.gl .img-talk5 {
	background: url('./images/img-complete-gl-jp.png') no-repeat center/cover !important;
	width: 17.8rem !important;
	height: 4.7rem !important;
	left : -16.2rem !important;
}
...
<body>
	<div class="wrap <%= appClass %>">
		...
		<main>
			<h1><strong>待って!</strong><br class="br"><p class="tit">正規品かどうかを確認しています。</p><br><p>性別を選択してください。</p></h1>
			...
			<article class="contents contents-age">
				<h2>1. 年齢層を選択してください。</h2>
				<div class="box-row">
					<button class="btn age" value="1">１０代</button>
					<button class="btn age" value="2">２０代</button>
					<button class="btn age" value="3">３０代</button>
					<button class="btn age" value="4">４０代</button>
					<button class="btn age" value="5">５０代以上</button>
				</div>
			</article>
			<article class="contents contents-show">
				<h2>2. モバイルアプリとウェブサイトのどちらから頻繁に買い物をしますか？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">モバイルアプリ</button>
					<button class="btn platform" value="2">ウェブサイト</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. オンライン・モバイルショッピングモールとオフライン購入先のどちらをお好みますか？</h2>
				<div class="box-row">
					<button class="btn situation" value="1">オンラン</button>
					<button class="btn situation" value="2">オフライン</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>4. ブランド公式モールとオフラインショッピングモールのどちらで購入することをお好みますか？</h2>
				<div class="box-row">
					<button class="btn preference" value="1">ブランド公式モール</button>
					<button class="btn preference" value="2">オンラインショッピングモール</button>
				</div>
			</article>
		</main>
		...
		<div class="modal modal-select">
			<div class="modal-popup">
				<div class="box">
					<p class="txt">お待ちください。欠けている項目がございます。<i class="ic-handUp"></i></p>
					<p class="txt">(全て作成後、OKボタンをクリックくださいませ。)</p>
...
function updateUI() {
  ...
  $warp.removeClass(function(i, cls) {
	...
	// 4-3. 버튼 상태 갱신
	$completeBtn.toggleClass('change', isCompleted) .text( isCompleted ? '真贋判定の結果をご確認くださいませ。' : '真贋判定アンケートにご参加くださいませ。');
	...
	// 4-5. 타이틀 텍스트 수정
	if (activeCount === 1) {
		$('.tit').text('スキャン情報を読み込んでいます。')
	} else if (activeCount === 2 ) {
		$('.tit').text('正規品がどうかを確認しています。')
	} else if (activeCount === 3 ) {
		$('.tit').text('商品情報を検討中です。')
	} else if (activeCount === 4 ) {
		$('.tit').text('ブランドの認証情報を確認中です。')
	} else if (activeCount === 5 ) {
		$('.tit').text('完了しました。下部のボタンをクリックくださいませ。')
	} else {
		$('.tit').text('本物であることの検証')
	}
