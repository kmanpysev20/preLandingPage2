...
<title>preLandingPage_jp3</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 購入前に商品の真贋判定をどのように行いましょうか？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">信頼がある購入先</button>
					<button class="btn platform" value="2">多様な認証取得有無</button>
					<button class="btn platform" value="3">レビュー確認</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 購入商品をスキャンした李湯は何でしょうか？</h2>
				<div class="box-row">
					<button class="btn situation" value="1">模倣品の疑いがあり</button>
					<button class="btn situation" value="2">A/Sサービスを受けたい</button>
					<button class="btn situation" value="3">イベント参加のために</button>
					<button class="btn situation" value="4">その他</button>
				</div>
			</article>
		</main>
