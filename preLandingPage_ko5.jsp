	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				...
				<div class="box-row">
					<button class="btn platform">1회</button>
					<button class="btn platform">2 ~ 4회</button>
					<button class="btn platform">5회 이상</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 할인 이벤트가있을 때 해당 제품과 같은 종류의 제품을 미리 더 구매하시는 편인가요?</h2>
				<div class="box-row">
					<button class="btn situation">네</button>
					<button class="btn situation">아니요</button>
				</div>
			</article>
		</main>
