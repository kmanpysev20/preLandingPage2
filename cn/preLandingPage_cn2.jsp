...
<title>preLandingPage_cn2</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 在购买这个产品的时候您考虑最多的要素是什么？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">价格</button>
					<button class="btn platform" value="2">品质</button>
					<button class="btn platform" value="3">设计</button>
					<button class="btn platform" value="4">品牌喜爱度</button>
					<button class="btn platform" value="5">便利性</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 在购买商品时，您会在多大程度上做价格的比较？</h2>
				<div class="box-row">
					<button class="btn situation" value="1">只针对各网上平台的价格进行对比</button>
					<button class="btn situation" value="2">对各种渠道进行完全对比后选择最低价进行购买</button>
					<button class="btn situation" value="3">不比较</button>
				</div>
			</article>
		</main>
