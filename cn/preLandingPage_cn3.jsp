...
<title>preLandingPage_cn3</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 该商品是如何确认为正品的？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">卖家信誉度</button>
					<button class="btn platform" value="2">相关资质认证</button>
					<button class="btn platform" value="3">买家评价</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 为什么会想要扫描本产品的防伪标签呢</h2>
				<div class="box-row">
					<button class="btn situation" value="1">疑似假货</button>
					<button class="btn situation" value="2">需要联系售后</button>
					<button class="btn situation" value="3">为了参加活动</button>
					<button class="btn situation" value="4">其他</button>
				</div>
			</article>
		</main>
