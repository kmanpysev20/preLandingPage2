...
<title>preLandingPage_cn1</title>
...
main .contents-gender .gender.img-men {
	background: url('./images/img-men-cn.svg') no-repeat center/contain;
}

main .contents-gender .gender.img-women {
	background: url('./images/img-women-cn.svg') no-repeat center/contain;
}
...
.cop .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-cop-cn.svg') no-repeat center/cover !important;
}
...
.cop .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-cop-cn.svg') no-repeat center/cover !important;
}

.cop .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-cop-cn.png') no-repeat center/cover;
	width: 10.9rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.cop .img-talk1 {
	background: url('./images/img-info-cop-cn.png') no-repeat center/cover !important;
	width: 10.4rem !important;
	left : 5.1rem !important;
}
.cop .img-talk2 {
	background: url('./images/img-data-cop-cn.png') no-repeat center/cover !important;
	width: 12.6rem !important;
	left : 5.4rem !important;
}
.cop .img-talk3 {
	background: url('./images/img-genue-cop-cn.png') no-repeat center/cover !important;
...
.cop .img-talk4 {
	background: url('./images/img-almost-cop-cn.png') no-repeat center/cover !important;
	width: 10.7rem !important;
	height: 4.8rem !important;
	left : -9.2rem !important;
}
.cop .img-talk5 {
	background: url('./images/img-complete-cop-cn.png') no-repeat center/cover !important;
...
.ht .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-ht-cn.svg') no-repeat center/cover !important;
}
...
.ht .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-ht-cn.svg') no-repeat center/cover !important;
}

.ht .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-ht-cn.png') no-repeat center/cover;
	width: 10.9rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.ht .img-talk1 {
	background: url('./images/img-info-ht-cn.png') no-repeat center/cover !important;
	width: 10.4rem !important;
	left : 5.1rem !important;
}
.ht .img-talk2 {
	background: url('./images/img-data-ht-cn.png') no-repeat center/cover !important;
	width: 12.6rem !important;
	left : 5.4rem !important;
}
.ht .img-talk3 {
	background: url('./images/img-genue-ht-cn.png') no-repeat center/cover !important;
    width: 13.7rem !important;
    height: 3.6rem !important;
    left: -4rem !important;
    top: -2.4rem !important;
...
.ht .img-talk4 {
	background: url('./images/img-almost-ht-cn.png') no-repeat center/cover !important;
	width: 10.7rem !important;
	height: 4.8rem !important;
	left : -9.2rem !important;
}
.ht .img-talk5 {
	background: url('./images/img-complete-ht-cn.png') no-repeat center/cover !important;
	width: 11.5rem !important;
	height: 4.7rem !important;
	left : -10rem !important;
}
...
.gl .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-gl-cn.svg') no-repeat center/cover !important;
}
...
.gl .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-gl-cn.svg') no-repeat center/cover !important;
}

.gl .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-gl-cn.png') no-repeat center/cover;
	width: 10.9rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.gl .img-talk1 {
	background: url('./images/img-info-gl-cn.png') no-repeat center/cover !important;
	width: 10.4rem !important;
	left : 5.1rem !important;
}
.gl .img-talk2 {
	background: url('./images/img-data-gl-cn.png') no-repeat center/cover !important;
	width: 12.6rem !important;
	left : 5.4rem !important;
}
.gl .img-talk3 {
	background: url('./images/img-genue-gl-cn.png') no-repeat center/cover !important;
    width: 13.7rem !important;
    height: 3.6rem !important;
    left: -4rem !important;
    top: -2.4rem !important;
...
.gl .img-talk4 {
	background: url('./images/img-almost-gl-cn.png') no-repeat center/cover !important;
	width: 10.7rem !important;
	height: 4.8rem !important;
	left : -9.2rem !important;
}
.gl .img-talk5 {
	background: url('./images/img-complete-gl-cn.png') no-repeat center/cover !important;
	width: 11.5rem !important;
	height: 4.7rem !important;
	left : -10rem !important;
}
...
<body>
	<div class="wrap <%= appClass %>">
		...
		<main>
			<h1><strong>请稍等！</strong><br class="br"><p class="tit">正在确认是否为正品</p><br><p>请选择性别。</p></h1>
			...
			<article class="contents contents-age">
				<h2>1. 请选择年龄层。</h2>
				<div class="box-row">
					<button class="btn age" value="1">10-19岁</button>
					<button class="btn age" value="2">20-29岁</button>
					<button class="btn age" value="3">30-39岁</button>
					<button class="btn age" value="4">40-49岁</button>
					<button class="btn age" value="5">50岁以上</button>
				</div>
			</article>
			<article class="contents contents-show">
				<h2>2. App和网站,更经常使用哪种方式购物？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">App</button>
					<button class="btn platform" value="2">网站</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 购买商品时更倾向线上购买还是线下购买？</h2>
				<div class="box-row">
					<button class="btn situation" value="1">线上</button>
					<button class="btn situation" value="2">线下</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>4. 您更倾向在品牌官网购买还是在网店购买？</h2>
				<div class="box-row">
					<button class="btn preference" value="1">品牌官网</button>
					<button class="btn preference" value="2">网店</button>
				</div>
			</article>
		</main>
		...
		<div class="modal modal-select">
			<div class="modal-popup">
				<div class="box">
					<p class="txt">请稍等！有尚未选择的项目<i class="ic-handUp"></i></p>
					<p class="txt">（请全部填写完成后点击按钮）</p>
					<i class="ic-warning"></i>
					<button class="check-btn">确认</button>
				</div>
			</div>
		</div>
		<!-- 선택 안되었을 때 팝업 [e] -->
...
function updateUI() {
  ...
  $warp.removeClass(function(i, cls) {
	...
	// 4-3. 버튼 상태 갱신
	$completeBtn.toggleClass('change', isCompleted) .text( isCompleted ? '请参与正品认证调查问卷！' : '请确认正品认证结果！');
