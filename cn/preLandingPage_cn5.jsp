...
<title>preLandingPage_cn5</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 1年以内会买几次该类型的产品呢？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">1次</button>
					<button class="btn platform" value="2">2~4次</button>
					<button class="btn platform" value="3">5次以上</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 让您决定购买本产品最重要的原因是什么？</h2>
				<div class="box-row">
					<button class="btn situation" value="1">会</button>
					<button class="btn situation" value="2">不会</button>
				</div>
			</article>
		</main>
