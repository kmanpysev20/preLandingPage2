...
<title>preLandingPage_cn4</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 是通过哪种渠道了解本产品的？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">电视/广播广告</button>
					<button class="btn platform" value="2">熟人介绍</button>
					<button class="btn platform" value="3">网络广告</button>
					<button class="btn platform" value="4">社交媒体</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 让您决定购买本产品最重要的原因是什么？</h2>
				<div class="box-row">
					<button class="btn situation" value="1">线上广告</button>
					<button class="btn situation" value="2">朋友推荐</button>
					<button class="btn situation" value="3">社媒推广</button>
					<button class="btn situation" value="4">媒体广告</button>
					<button class="btn situation" value="5">买家秀</button>
				</div>
			</article>
		</main>
