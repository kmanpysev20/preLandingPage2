...
<title>preLandingPage_cn6</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 何种方式购买的？</h2>
				<div class="box-row">
					<button class="btn platform" value="1">网店</button>
					<button class="btn platform" value="2">二手交易</button>
					<button class="btn platform" value="3">熟人赠送</button>
					<button class="btn platform" value="4">线下小店</button>
					<button class="btn platform" value="5">个人网店/代购</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 选择这个渠道购买的最大原因是什么？</h2>
				<div class="box-row">
					<button class="btn situation" value="1">便宜</button>
					<button class="btn situation" value="2">卖家信誉度高</button>
					<button class="btn situation" value="3">买家秀，好评度</button>
					<button class="btn situation" value="4">有官方品控的购买途径</button>
				</div>
			</article>
		</main>
