...
<title>preLandingPage_ko2</title>
...
@keyframes pulse-shadow-cop {
  ...
  50% {
    box-shadow: 0 -0.4rem 4rem 0.1rem #368AFE;
  }
}
...
@keyframes pulse-shadow-ht {
  ...
  50% {
    box-shadow: 0 -0.4rem 4rem 0.1rem black;
  }
}	
/* ht 전용 [e] */
...
@keyframes pulse-shadow-gl {
  ...
  50% {
    box-shadow: 0 -0.4rem 4rem 0.1rem #367f76;
  }
}	
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 제품을 구매할 때 가장 먼저 고려하는 요소는 우멋인가요?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">가격</button>
					<button class="btn platform" value="2">품질</button>
					<button class="btn platform" value="3">디자인</button>
					<button class="btn platform" value="4">브랜드 선호도</button>
					<button class="btn platform" value="5">편의성</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 제품을 구매할 때 얼마나 가격 비교를 하시나요?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">온라인 플랫폼만 대상으로 비교</button>
					<button class="btn situation" value="2">철저한 비교 후 최저가 구매</button>
					<button class="btn situation" value="3">안함</button>
				</div>
			</article>
		</main>
