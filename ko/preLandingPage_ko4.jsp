...
<title>preLandingPage_ko4</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 구입하신 제품을 어떤 경로로 알게 되셨나요?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">TV / 라디오 광고</button>
					<button class="btn platform" value="2">지인추천</button>
					<button class="btn platform" value="3">온라인 광고</button>
					<button class="btn platform" value="4">SNS</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 구매 결정에 가장 큰 영향을 미치는 요소는 무엇인가요?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">온라인 광고</button>
					<button class="btn situation" value="2">지인 추천</button>
					<button class="btn situation" value="3">SNS 컨텐츠</button>
					<button class="btn situation" value="4">매체 광고</button>
					<button class="btn situation" value="5">리뷰</button>
				</div>
			</article>
		</main>
