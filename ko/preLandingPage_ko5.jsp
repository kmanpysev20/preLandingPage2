...
<title>preLandingPage_ko5</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 구입하신 제품과 비슷한 종류의 제품을 1년에 몇 회 구매하시나요?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">1회</button>
					<button class="btn platform" value="2">2 ~ 4회</button>
					<button class="btn platform" value="3">5회 이상</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 할인 이벤트가있을 때 해당 제품과 같은 종류의 제품을 미리 더 구매하시는 편인가요?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">네</button>
					<button class="btn situation" value="2">아니요</button>
				</div>
			</article>
		</main>
