	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				...
				<div class="box-row">
					<button class="btn platform" value="1">신뢰가 가는 구매처</button>
					<button class="btn platform" value="2">다양한 인증 획득</button>
					<button class="btn platform" value="3">후기 확인</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 구매 제품을 스캔한 이유는 무엇인가요?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">가품 의심이 들어서</button>
					<button class="btn situation" value="2">A/S 서비스 받으려고</button>
					<button class="btn situation" value="3">이벤트 참여를 위해서</button>
					<button class="btn situation" value="4">기타</button>
				</div>
			</article>
		</main>
