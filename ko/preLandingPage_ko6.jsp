...
<title>preLandingPage_ko6</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. 구매 경로가 어떻게 되나요?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">온라인 오픈 마켓</button>
					<button class="btn platform" value="2">중고거래</button>
					<button class="btn platform" value="3">지인 증정</button>
					<button class="btn platform" value="4">오프라인 로드샵</button>
					<button class="btn platform" value="5">SNS 개인 판매자</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 구매한 판매처를 선택한 가장 큰 이유는 무엇인가요?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">저렴한 가격</button>
					<button class="btn situation" value="2">신뢰가 가는 구매처</button>
					<button class="btn situation" value="3">후기, 평점 우수</button>
					<button class="btn situation" value="4">제한적인 구매처</button>
				</div>
			</article>
		</main>
