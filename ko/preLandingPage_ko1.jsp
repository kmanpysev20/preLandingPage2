...
<title>preLandingPage_ko1</title>
...
.cop .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-cop.svg') no-repeat center/cover !important;
}
...
.cop .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-cop.svg') no-repeat center/cover !important;
}
...
.cop .img-talk4 {
	background: url('./images/img-almost-cop.png') no-repeat center/cover !important;
...
.ht .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-ht.svg') no-repeat center/cover !important;
}
...
.ht .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-ht.svg') no-repeat center/cover !important;
}
...
.ht .img-talk4 {
	background: url('./images/img-almost-ht.png') no-repeat center/cover !important;
	width: 12rem !important;
	height: 4.8rem !important;
	left : -10.6rem !important;
}
...
.gl .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-gl.svg') no-repeat center/cover !important;
}
...
.gl .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-gl.svg') no-repeat center/cover !important;
}
...
.gl .img-talk4 {
	background: url('./images/img-almost-gl.png') no-repeat center/cover !important;
	width: 12rem !important;
	height: 4.8rem !important;
	left : -10.6rem !important;
}
...
<body>
	<div class="wrap <%= appClass %>">
		...
		<main>
			<h1><strong>잠시만요!</strong><br class="br"><p class="tit">정품 여부를 확인하는 중입니다.</p><br><p>성별을 선택해주세요.</p></h1>
			...
			<article class="contents contents-age">
				...
				<div class="box-row">
					<button class="btn age" value="1">10대</button>
					<button class="btn age" value="2">20대</button>
					<button class="btn age" value="3">30대</button>
					<button class="btn age" value="4">40대</button>
					<button class="btn age" value="5">50대 이상</button>
				</div>
			</article>
			<article class="contents contents-show">
				<h2>2. 모바일 앱과 웹사이트 중 어느 쪽에서 더 자주 쇼핑을 하시나요?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">모바일 앱</button>
					<button class="btn platform" value="2">웹 사이트</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 온라인/모바일 쇼핑몰과 오프라인 구매처 중 어느 곳을 더 선호하시나요?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">온라인</button>
					<button class="btn situation" value="2">오프라인</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>4. 브랜드 공식몰과 온라인 쇼핑몰 중 어디에서 구매하는 것을 선호하시나요?</h2>
				<div class="box-row">
					<button class="btn preference" value="1">브랜드 공식몰</button>
					<button class="btn preference" value="2">온라인 쇼핑몰</button>
				</div>
			</article>
		</main>
...
function updateUI() {
  ...
  $warp.removeClass(function(i, cls) {
	...
	// 4-3. 버튼 상태 갱신
	$completeBtn.toggleClass('change', isCompleted) .text( isCompleted ? '정품 결과를 지금 확인해보세요!' : '공식 정품 인증 설문에 참여해주세요!');
	...
	// 4-5. 타이틀 텍스트 수정
	if (activeCount === 1) {
		$('.tit').text('스캔 정보를 불러오고 있어요')
	} else if (activeCount === 2 ) {
		$('.tit').text('정품 여부를 분석하고 있어요')
	} else if (activeCount === 3 ) {
		$('.tit').text('제품 정보를 검토 중입니다')
	} else if (activeCount === 4 ) {
		$('.tit').text('브랜드 인증 정보를 확인 중입니다')
	} else if (activeCount === 5 ) {
		$('.tit').text('완료되었어요! 하단 버튼을 눌러주세요')
	} else {
		$('.tit').text('정품 여부를 확인하는 중입니다')
	}
