...
<title>preLandingPage_th4</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. คุณรู้จักสินค้าที่ซื้อผ่านช่องทางใด?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">โฆษณาจากโทรทัศน์หรือวิทยุ</button>
					<button class="btn platform" value="2">เพื่อนหรือคนรู้จักแนะนำ</button>
					<button class="btn platform" value="3">โฆษณาออนไลน์</button>
					<button class="btn platform" value="4">โซเชียลมีเดีย</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. อะไรคือปัจจัยที่มีอิทธิพลต่อการตัดสินใจซื้อของคุณมากที่สุด?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">โฆษณาออนไลน์</button>
					<button class="btn situation" value="2">คำแนะนำจากเพื่อน</button>
					<button class="btn situation" value="3">สื่อโซเชียลมีเดีย</button>
					<button class="btn situation" value="4">โฆษณาตามสื่อต่าง ๆ</button>
					<button class="btn situation" value="5">รีวิวจากผู้ใช้งาน</button>
				</div>
			</article>
		</main>
...
function completeBtn() {
		...
		if($('.gender').hasClass('active') && $('.age').hasClass('active') && $('.platform').hasClass('active') && $('.situation').hasClass('active')) {
			...
			form.append('<input type="hidden" name="page" value="4">');
