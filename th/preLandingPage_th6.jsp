...
<title>preLandingPage_th6</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. คุณซื้อสินค้านี้ผ่านช่องทางใด?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">ร้านค้าออนไลน์</button>
					<button class="btn platform" value="2">ซื้อขายมือสอง</button>
					<button class="btn platform" value="3">คนรู้จักแนะนำ</button>
					<button class="btn platform" value="4">ร้านค้าออฟไลน์</button>
					<button class="btn platform" value="5">ผู้ขายผ่านโซเชียลมีเดียส่วนตัว</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. เหตุผลหลักที่คุณเลือกซื้อสินค้านี้จากช่องทางนั้นคืออะไร?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">ราคาถูก</button>
					<button class="btn situation" value="2">ร้านน่าเชื่อถือ</button>
					<button class="btn situation" value="3">รีวิวและคะแนนดี</button>
					<button class="btn situation" value="4">หาซื้อได้เฉพาะบางร้าน</button>
				</div>
			</article>
		</main>
...
function completeBtn() {
		...
		if($('.gender').hasClass('active') && $('.age').hasClass('active') && $('.platform').hasClass('active') && $('.situation').hasClass('active')) {
			...
			form.append('<input type="hidden" name="page" value="2">');
