...
<title>preLandingPage_th1</title>
...
main .contents-gender .gender.img-men {
	background: url('./images/img-men-th.svg') no-repeat center/contain;
}

main .contents-gender .gender.img-women {
	background: url('./images/img-women-th.svg') no-repeat center/contain;
}
...
.cop .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-cop-th.svg') no-repeat center/cover !important;
}
...
.cop .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-cop-th.svg') no-repeat center/cover !important;
}

.cop .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-cop-th.png') no-repeat center/cover;
	width: 11.2rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.cop .img-talk1 {
	background: url('./images/img-info-cop-th.png') no-repeat center/cover !important;
	width: 14rem !important;
	left : 5.1rem !important;
}
.cop .img-talk2 {
	background: url('./images/img-data-cop-th.png') no-repeat center/cover !important;
	width: 14.8rem !important;
	left : 5.4rem !important;
}
.cop .img-talk3 {
	background: url('./images/img-genue-cop-th.png') no-repeat center/cover !important;
...
.cop .img-talk4 {
	background: url('./images/img-almost-cop-th.png') no-repeat center/cover !important;
	width: 15.2rem !important;
	height: 4.8rem !important;
	left : -14rem !important;
}
.cop .img-talk5 {
	background: url('./images/img-complete-cop-th.png') no-repeat center/cover !important;
...
.ht .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-ht-th.svg') no-repeat center/cover !important;
}
...
.ht .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-ht-th.svg') no-repeat center/cover !important;
}

.ht .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-ht-th.png') no-repeat center/cover;
	width: 11.2rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.ht .img-talk1 {
	background: url('./images/img-info-ht-th.png') no-repeat center/cover !important;
	width: 14rem !important;
	left : 5.1rem !important;
}
.ht .img-talk2 {
	background: url('./images/img-data-ht-th.png') no-repeat center/cover !important;
	width: 14.8rem !important;
	left : 5.4rem !important;
}
.ht .img-talk3 {
	background: url('./images/img-genue-ht-th.png') no-repeat center/cover !important;
	width: 19.9rem !important;
	height: 3.6rem !important;
	left : -5.5rem !important;
	top : -2.4rem !important;
...
.ht .img-talk4 {
	background: url('./images/img-almost-ht-th.png') no-repeat center/cover !important;
	width: 15.2rem !important;
	height: 4.8rem !important;
	left : -14rem !important;
}
.ht .img-talk5 {
	background: url('./images/img-complete-ht-th.png') no-repeat center/cover !important;
	width: 16.5rem !important;
	height: 4.7rem !important;
	left : -16.2rem !important;
}
...
.gl .img-men.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-men-active-gl-th.svg') no-repeat center/cover !important;
}
...
.gl .img-women.active {
	...
	color : unset;
	border: unset;
	background: url('./images/img-women-active-gl-th.svg') no-repeat center/cover !important;
}

.gl .step [class*=img-talk] {
	position: absolute;
	background: url('./images/img-wait-gl-th.png') no-repeat center/cover;
	width: 11.2rem;
	height: 4.7rem;
	left : 5.2rem;
	top: -2rem;
...
.gl .img-talk1 {
	background: url('./images/img-info-gl-th.png') no-repeat center/cover !important;
	width: 14rem !important;
	left : 5.1rem !important;
}
.gl .img-talk2 {
	background: url('./images/img-data-gl-th.png') no-repeat center/cover !important;
	width: 14.8rem !important;
	left : 5.4rem !important;
}
.gl .img-talk3 {
	background: url('./images/img-genue-gl-th.png') no-repeat center/cover !important;
	width: 19.9rem !important;
	height: 3.6rem !important;
	left : -5.5rem !important;
	top : -2.4rem !important;
...
.gl .img-talk4 {
	background: url('./images/img-almost-gl-th.png') no-repeat center/cover !important;
	width: 15.2rem !important;
	height: 4.8rem !important;
	left : -14rem !important;
}
.gl .img-talk5 {
	background: url('./images/img-complete-gl-th.png') no-repeat center/cover !important;
	width: 16.5rem !important;
	height: 4.7rem !important;
	left : -16.2rem !important;
}
...
<body>
	<div class="wrap <%= appClass %>">
		...
		<main>
			<h1><strong>กรุณารอสักครู่!</strong><br class="br"><p class="tit">ขณะนี้ระบบกำลังตรวจสอบสินค้า</p><br><p>กรุณาเลือกเพศ</p></h1>
			...
			<article class="contents contents-age">
				<h2>1. กรุณาเลือกช่วงอายุ</h2>
				<div class="box-row">
					<button class="btn age" value="1">10 ปี</button>
					<button class="btn age" value="2">20 ปี</button>
					<button class="btn age" value="3">30 ปี</button>
					<button class="btn age" value="4">40 ปี</button>
					<button class="btn age" value="5">50 ปีขึ้นไป</button>
				</div>
			</article>
			<article class="contents contents-show">
				<h2>2. คุณชอบซื้อของผ่านแอปมือถือหรือเว็บไซต์?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">แอปมือถือ</button>
					<button class="btn platform" value="2">เว็บไซต์</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. คุณชอบซื้อสินค้าผ่านร้านค้าออนไลน์/แอปมือถือ หรือร้านค้าออฟไลน์?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">ออนไลน์</button>
					<button class="btn situation" value="2">ออฟไลน์</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>4. คุณชอบซื้อสินค้าผ่านเว็บไซต์ของแบรนด์ หรือผ่านร้านค้าออนไลน์ทั่วไป?</h2>
				<div class="box-row">
					<button class="btn preference" value="1">เว็บไซต์ของแบรนด์</button>
					<button class="btn preference" value="2">ร้านค้าออนไลน์</button>
				</div>
			</article>
		</main>
		...
		<div class="modal modal-select">
			<div class="modal-popup">
				<div class="box">
					<p class="txt">กรุณารอสักครู่! คุณกรอกข้อมูลไม่ครบถ้วน<i class="ic-handUp"></i></p>
					<p class="txt">(กรุณากรอกข้อมูลให้ครบถ้วนแล้วกดยืนยัน!)</p>
					<i class="ic-warning"></i>
					<button class="check-btn">ยืนยัน</button>
				</div>
			</div>
		</div>
		<!-- 선택 안되었을 때 팝업 [e] -->
...
function updateUI() {
  ...
  $warp.removeClass(function(i, cls) {
	...
	// 4-3. 버튼 상태 갱신
	$completeBtn.toggleClass('change', isCompleted) .text( isCompleted ? 'ตรวจสอบผลลัพธ์ของสินค้าของแท้ได้เลยตอนนี้!' : 'กรุณาตอบแบบสำรวจการรับรองสินค้าของแท้!');
	...
	// 4-5. 타이틀 텍스트 수정
	if (activeCount === 1) {
		$('.tit').text('กำลังดึงข้อมูลการสแกน')
	} else if (activeCount === 2 ) {
		$('.tit').text('กำลังตรวจสอบสินค้าของแท้')
	} else if (activeCount === 3 ) {
		$('.tit').text('กำลังตรวจสอบข้อมูลสินค้า')
	} else if (activeCount === 4 ) {
		$('.tit').text('กำลังยืนยันข้อมูลการรับรองจากแบรนด์')
	} else if (activeCount === 5 ) {
		$('.tit').text('เสร็จสิ้น! กรุณากดปุ่มด้านล่าง')
	} else {
		$('.tit').text('การตรวจสอบความถูกต้อง')
	}
