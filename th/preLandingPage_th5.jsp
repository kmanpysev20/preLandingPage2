...
<title>preLandingPage_th5</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. โดยปกติคุณซื้อสินค้าประเภทนี้กี่ครั้งต่อปี?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">1 ครั้ง</button>
					<button class="btn platform" value="2">2-4 ครั้ง</button>
					<button class="btn platform" value="3">มากกว่า 5 ครั้ง</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. เวลามีโปรโมชันลดราคา คุณมักจะซื้อสินค้าประเภทนี้ตุนไว้ล่วงหน้าหรือไม่?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">ใช่</button>
					<button class="btn situation" value="2">ไม่ใช่</button>
				</div>
			</article>
		</main>
