...
<title>preLandingPage_th3</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. ก่อนซื้อสินค้า คุณตรวจสอบสินค้าของแท้หรือไม่?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">เลือกซื้อจากร้านค้าที่น่าเชื่อถือ</button>
					<button class="btn platform" value="2">ตรวจสอบการรับรองจากแหล่งต่าง ๆ</button>
					<button class="btn platform" value="3">อ่านรีวิวจากผู้ใช้คนอื่น</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. คุณสแกนสินค้าที่ซื้อเพราะเหตุผลใด?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">สงสัยว่าอาจเป็นของปลอม</button>
					<button class="btn situation" value="2">ต้องการรับบริการหลังการขาย (A/S)</button>
					<button class="btn situation" value="3">ร่วมกิจกรรมหรือลุ้นรับของรางวัล</button>
					<button class="btn situation" value="4">อื่น ๆ</button>
				</div>
			</article>
		</main>
