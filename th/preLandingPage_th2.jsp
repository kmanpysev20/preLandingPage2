...
<title>preLandingPage_th2</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. ปัจจัยแรกที่คุณคำนึงถึงเมื่อซื้อสินค้าคืออะไร?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">ราคา</button>
					<button class="btn platform" value="2">คุณภาพ</button>
					<button class="btn platform" value="3">การออกแบบ</button>
					<button class="btn platform" value="4">ความนิยมของแบรนด์</button>
					<button class="btn platform" value="5">ความสะดวกสบาย</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. เมื่อซื้อสินค้า คุณเปรียบเทียบราคาก่อนตัดสินใจมากน้อยแค่ไหน?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">เปรียบเทียบเฉพาะในแพลตฟอร์มออนไลน์</button>
					<button class="btn situation" value="2">เปรียบเทียบอย่างละเอียดและเลือกซื้อราคาถูกที่สุด</button>
					<button class="btn situation" value="3">ไม่เปรียบเทียบราคา</button>
				</div>
			</article>
		</main>
