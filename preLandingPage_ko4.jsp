	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				...
				<div class="box-row">
					<button class="btn platform">TV / 라디오 광고</button>
					<button class="btn platform">지인추천</button>
					<button class="btn platform">온라인 광고</button>
					<button class="btn platform">SNS</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. 구매 결정에 가장 큰 영향을 미치는 요소는 무엇인가요?</h2>
				<div class="box-row">
					<button class="btn situation">온라인 광고</button>
					<button class="btn situation">지인 추천</button>
					<button class="btn situation">SNS 컨텐츠</button>
					<button class="btn situation">매체 광고</button>
					<button class="btn situation">리뷰</button>
				</div>
			</article>
		</main>
