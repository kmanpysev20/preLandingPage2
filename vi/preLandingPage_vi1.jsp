...
<title>preLandingPage_vi1</title>
...
.cop .img-talk3 {
	background: url('./images/img-genue-cop-vi.png') no-repeat center/cover !important;
...
.ht .img-talk3 {
	background: url('./images/img-genue-ht-vi.png') no-repeat center/cover !important;
	width: 16.5rem !important;
	height: 3.6rem !important;
	left : -5.5rem !important;
	top : -2.4rem !important;
...
.gl .img-talk3 {
	background: url('./images/img-genue-gl-vi.png') no-repeat center/cover !important;
	width: 16.5rem !important;
	height: 3.6rem !important;
	left : -5.5rem !important;
	top : -2.4rem !important;
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. Giữa ứng dụng di động và trang web, bạn thường mua sắm ở đâu nhiều hơn?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">App di động</button>
					<button class="btn platform" value="2">Website</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. Bạn thích mua sắm trực tuyến trên Store / App di dộng hay trực tiếp hơn?</h2>
				<div class="box-row">
			...
			<article class="contents contents-preference">
				<h2>4. Bạn thích mua hàng ở cửa hàng chính hãng của thương hiệu hay store trực tuyến hơn?</h2>
				<div class="box-row">
					<button class="btn preference" value="1">Cửa hàng chính hãng</button>
					<button class="btn preference" value="2">Store trực tuyến</button>
				</div>
			</article>
		</main>
...
function updateUI() {
  ...
  $warp.removeClass(function(i, cls) {
	...
	// 4-3. 버튼 상태 갱신
	$completeBtn.toggleClass('change', isCompleted) .text( isCompleted ? 'Hãy xác nhận kết quả bây giờ!' : 'Hãy tham gia khảo sát chứng nhận hàng chính hãng!');
	...
	if (activeCount === 1) {
		...
		$('.tit').text('Đang xác nhận thông tin chứng nhận thương hiệu')
