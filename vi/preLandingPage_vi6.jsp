...
<title>preLandingPage_vi5</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. Bạn mua qua kênh nào?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">Chợ online</button>
					<button class="btn platform" value="2">Hàng đã qua sử dụng</button>
					<button class="btn platform" value="3">Quà tặng từ người quen</button>
					<button class="btn platform" value="4">Cửa hàng offline</button>
					<button class="btn platform" value="5">Mua qua người bán trên SNS</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. Khi có khuyến mãi, có mua tích trữ khi giảm giá không?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">Giá rẻ</button>
					<button class="btn situation" value="2">Nơi mua đáng tin</button>
					<button class="btn situation" value="3">Đánh giá tốt</button>
					<button class="btn situation" value="4">Khó tìm nơi khác</button>
				</div>
			</article>
		</main>
