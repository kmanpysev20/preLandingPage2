...
<title>preLandingPage_vi2</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. Khi mua sản phẩm, yếu tố nào bạn cân nhắc đầu tiên?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">Giá cả</button>
					<button class="btn platform" value="2">Chất lượng</button>
					<button class="btn platform" value="3">Thiết kế</button>
					<button class="btn platform" value="4">Thương hiệu yêu thích</button>
					<button class="btn platform" value="5">Sự tiện lợi</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. Khi mua sản phẩm, bạn so sánh giá cả ở mức độ nào?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">Chỉ so sánh trên các nền tảng online</button>
					<button class="btn situation" value="2">So sánh kỹ lưỡng rồi mua ở nơi có giá thấp nhất</button>
					<button class="btn situation" value="3">Không so sánh</button>
				</div>
			</article>
		</main>
