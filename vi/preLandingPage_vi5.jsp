	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. Mỗi năm bạn mua sản phẩm tương tự bao nhiêu lần?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">1 lần</button>
					<button class="btn platform" value="2">2~4 lần</button>
					<button class="btn platform" value="3">5 lần trở lên</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. Khi có khuyến mãi, có mua tích trữ khi giảm giá không?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">Có</button>
					<button class="btn situation" value="2">Không</button>
				</div>
			</article>
		</main>
