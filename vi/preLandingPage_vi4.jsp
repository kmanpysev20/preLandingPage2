...
<title>preLandingPage_vi4</title>
	...
	<div class="wrap <%= appClass %>">
		...
		<main>
			...
			<article class="contents contents-show">
				<h2>2. Bạn biết đến sản phẩm đã mua qua kênh nào?</h2>
				<div class="box-row">
					<button class="btn platform" value="1">Quảng cáo TV / Radio</button>
					<button class="btn platform" value="2">Giới thiệu từ người quen</button>
					<button class="btn platform" value="3">Quảng cáo trực tuyến</button>
					<button class="btn platform" value="4">Mạng xã hội (SNS)</button>
				</div>
			</article>
			<article class="contents contents-preference">
				<h2>3. Lý do bạn quét sản phẩm đã mua là gì?</h2>
				<div class="box-row">
					<button class="btn situation" value="1">Quảng cáo trực tuyến</button>
					<button class="btn situation" value="2">Giới thiệu từ người quen</button>
					<button class="btn situation" value="3">Nội dung trên SNS</button>
					<button class="btn situation" value="4">Quảng cáo trên báo/magazine</button>
					<button class="btn situation" value="5">Đánh giá</button>
				</div>
			</article>
		</main>
